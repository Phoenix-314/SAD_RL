# Code from here until line 17 is just to silence warnings. When rewriting this file, import the files that actually implement these classes
pg = None
QUIT, KEYDOWN, K_BACKSPACE, K_KP_ENTER, K_RETURN, K_TAB = 0,0,0,0,0
Path = None
